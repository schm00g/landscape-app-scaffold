const _jsxFileName = "/Users/shanemcgrath/create-landscape-app/src/js/components/root.js";import React, { Component } from 'react';
  ...
  render() {
    ...
    return (
      React.createElement(BrowserRouter, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 16}}
        ...
        , React.createElement(Route, { exact: true, path: "/~tlionsden", render:  () => {
          return (
            React.createElement('div', { className: "pa3 w-100" , __self: this, __source: {fileName: _jsxFileName, lineNumber: 21}}
              , React.createElement('h1', { className: "mt0 f2" , __self: this, __source: {fileName: _jsxFileName, lineNumber: 22}}, "tlionsden")
